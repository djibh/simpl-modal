...
function Modal(_a) {
    ...
    return (react_1.default.createElement("div", { id: 'modal', role: 'dialog', title: 'Show content with modal', "aria-label": "Show content with modal", className: "modal ".concat(isOpen ? "modal-active" : "", " ").concat(className), "data-close-button": showCloseButton, "data-animated": animated, "data-theme": theme },
        react_1.default.createElement("div", { className: 'modal__content' },
            react_1.default.createElement("button", { id: 'modal__close-button', type: 'button', "aria-label": 'Close modal', onClick: handleClick }, "X"),
            children)));
}
